"""Typed Core domain dataset handle (measurements remain lazily accessible)."""
...
@dataclass
class CoreDataset:
    """In-memory dims/catalogs + path-backed measurements for future chunked use."""
    ...
    # Optional eager materialization for small fixtures / tests
